...
const features={
   ...
   revert: async (transactionId) => { 
    ...
    payout_configuration: async (algorithm, send_notification, destination_type, roof_amount, destination, rate_frequency) => { 

        return http.post(opts.revertEndpoint,
            {algorithm, send_notification, destination_type, roof_amount, destination, rate_frequency})
